      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-10 grid gap-2 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative group lg:row-span-2">
            {/* Background with group-hover */}
            <div className="absolute inset-px rounded-lg bg-[#1b0c27] border border-solid border-[#3e2046] group-hover:border-[#5f3c69] transition-colors duration-200 lg:rounded-l-[2rem]"></div>
            ...
            {/* Ring layer with pointer-events-none */}
            <div className="pointer-events-none absolute inset-px rounded-lg ring-1 shadow-sm ring-black/5 lg:rounded-l-[2rem]"></div>
          </div>

          <div className="relative group max-lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-[#1b0c27] border border-solid border-[#3e2046] group-hover:border-[#5f3c69] transition-colors duration-200 max-lg:rounded-t-[2rem]"></div>
          ...
          <div className="relative group max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div className="absolute inset-px rounded-lg bg-[#1b0c27] border border-solid border-[#3e2046] group-hover:border-[#5f3c69] transition-colors duration-200"></div>
          ...
          <div className="relative group lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-[#1b0c27] border border-solid border-[#3e2046] group-hover:border-[#5f3c69] transition-colors duration-200 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              ...
              <div className="relative min-h-[30rem] w-full grow">
                <div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl border border-[#3e2046] bg-jukeboxd shadow-2xl">
