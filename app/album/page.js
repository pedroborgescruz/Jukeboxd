        ...
        <CardBody className="overflow-visible py-2 flex-col items-center">
         ...
         <div className="flex gap-3">
            ...
            <div className="flex gap-1 items-center">
              ...
              <small className="text-gray-500 mb-1 ">432k</small>
            </div>
          ...
          <div className="flex gap-1 items-center">
            ...
            <small className="text-gray-500 mb-1 ">121k</small>
          </div>

          <Tooltip content="Listened" className="bg-primary" showArrow={true}>
            <div className="flex gap-1 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
