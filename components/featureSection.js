...
export default function Example() {
  return (
    <div className="bg-primary overflow-hidden py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className="text-base/7 font-semibold accent-jukeboxd">Discover more</h2>
              <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-jukeboxd sm:text-5xl">
                A better way to track your listening
              </p>
              <p className="mt-6 text-lg/8 text-jukeboxd">
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-jukeboxd lg:max-w-none">
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold accent-jukeboxd">
                      <feature.icon aria-hidden="true" className="absolute accent-jukeboxd top-1 left-1 size-5" />
                      {feature.name}
                    </dt>{' '}
