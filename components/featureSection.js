        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className="text-base/7 font-semibold text-primary">Discover more</h2>
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base/7 text-primary lg:max-w-none">
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold primary-jukeboxd">
                      <feature.icon aria-hidden="true" className="absolute primary-jukeboxd top-1 left-1 size-5" />
                      {feature.name}
                    </dt>{' '}
